  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    ...
    if (isDraggingLeft || (isDraggingRight && rulerRef.current)) {
      ...
      if (container) {
        ...
        /**
         * Bu tarz durumlarda bağlı olan kontainerin sol üst köşeye olan uzaklığını 
         * tıkladığımız konumdan çıkarmamız gerekiyor ki içerdeki divin tam tıklanan konumunu 
         * hesaplayabilelim
         */
